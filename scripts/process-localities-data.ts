// scripts/process-localities-data.ts
...
async function downloadLocalitiesData() {
  // This query gets all localities in Ghana with different place types
  const query = `
  ...
  try {
    ...
    console.log("THIS IS THE RESPONSE FROM OPENSTREETMAP: ", response)
